...
export default function DailyNewsScreen({ navigation }) {
  ...
  const header = (
    <View>
      ...
      {activeTab === 'for-you' && <SectionTitle>Top stories</SectionTitle>}
      {activeTab !== 'for-you' && (
...
const styles = StyleSheet.create({
  ...
  brandBlue: { color: BLUE, fontSize: 27, fontWeight: '800' },
  brandDark: { color: '#3C4043', fontSize: 27, fontWeight: '700' },
  searchWrap: {
    marginHorizontal: 24,
    marginTop: -12,
    marginBottom: 12,
  ...
  tabText: { color: TEXT, fontSize: 20, fontWeight: '700' },
  tabTextActive: { color: '#0B3046' },
  dividerBand: { height: 14, backgroundColor: '#F1F3F7', borderTopWidth: 1, borderTopColor: '#EDF0F5' },
  sectionTitleWrap: {
    paddingHorizontal: 24,
    paddingTop: 26,
    paddingBottom: 14,
  ...
  sectionTitle: { color: BLUE, fontSize: 31, fontWeight: '800', marginRight: 4 },
  categoryHeader: { paddingHorizontal: 24, paddingTop: 26, paddingBottom: 14 },
  categoryTitle: { color: TEXT, fontSize: 31, fontWeight: '800' },
  categorySub: { color: MUTED, fontSize: 14, marginTop: 6 },
  heroStory: { paddingHorizontal: 24, paddingBottom: 22 },
  heroImage: { width: '100%', height: 238, borderRadius: 17, backgroundColor: '#DDE3EA' },
  emptyImage: { alignItems: 'center', justifyContent: 'center' },
  storyBody: { paddingTop: 16 },
  sourceRow: { flexDirection: 'row', alignItems: 'center', minHeight: 25 },
  sourceMark: {
    width: 22,
    height: 22,
    borderRadius: 3,
  ...
  sourceMarkText: { color: '#D93025', fontSize: 16, fontWeight: '900' },
  sourceText: { color: '#3C4043', fontSize: 18, flex: 1 },
  heroTitle: { color: '#050505', fontSize: 29, lineHeight: 38, fontWeight: '500', marginTop: 12 },
  metaRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 13 },
  timeText: { color: '#3C4043', fontSize: 17 },
  ...
  compactTitle: { color: '#050505', fontSize: 25, lineHeight: 33, fontWeight: '500', marginTop: 10 },
  thumbImage: { width: 112, height: 102, borderRadius: 13, marginTop: 8 },
  relatedWrap: { paddingBottom: 20, borderTopWidth: 1, borderTopColor: DIVIDER },
  relatedCard: {
    width: 285,
    minHeight: 155,
    borderWidth: 1,
  ...
  relatedTitle: { color: TEXT, fontSize: 19, lineHeight: 26, marginTop: 12, fontWeight: '500' },
  ...
  coverageText: { color: TEXT, fontSize: 19, fontWeight: '500' },
  picksHeader: { height: 86, backgroundColor: '#F1F3F7', justifyContent: 'center', paddingHorizontal: 24 },
  picksText: { color: '#673AB7', fontSize: 31, fontWeight: '500' },
