...
module.exports = {
  ...
  VIDEO_STORAGE_PROVIDER: process.env.VIDEO_STORAGE_PROVIDER || "bunny",
  VIDEO_FALLBACK_PROVIDER: process.env.VIDEO_FALLBACK_PROVIDER || "mux",
  ...
  OPAY_INITIALIZE_URL: process.env.OPAY_INITIALIZE_URL || "",
  OPAY_VERIFY_URL: process.env.OPAY_VERIFY_URL || "",
  PALMPAY_APP_ID: process.env.PALMPAY_APP_ID || "",
  PALMPAY_MERCHANT_ID: process.env.PALMPAY_MERCHANT_ID || "",
  PALMPAY_PUBLIC_KEY: process.env.PALMPAY_PUBLIC_KEY || "",
  PALMPAY_SECRET_KEY: process.env.PALMPAY_SECRET_KEY || "",
  PALMPAY_INITIALIZE_URL: process.env.PALMPAY_INITIALIZE_URL || "",
  PALMPAY_VERIFY_URL: process.env.PALMPAY_VERIFY_URL || "",
